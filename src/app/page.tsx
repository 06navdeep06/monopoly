  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -left-40 w-80 h-80 bg-game-gold/10 rounded-full blur-3xl" />
        <div className="absolute -bottom-40 -right-40 w-80 h-80 bg-game-success/10 rounded-full blur-3xl" />
      </div>
      ...
      >
        <motion.h1 
          className="font-display text-6xl sm:text-8xl font-extrabold text-game-gold mb-4 text-shadow-lg"
          initial={{ scale: 0.8 }}
          animate={{ scale: 1 }}
